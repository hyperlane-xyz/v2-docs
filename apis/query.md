...
Calls can be easily encoded with the `abi.encodeCall` function. As with the [accounts](accounts/ "mention"), you can either call `dispatch` directly or pass `Call` structs
