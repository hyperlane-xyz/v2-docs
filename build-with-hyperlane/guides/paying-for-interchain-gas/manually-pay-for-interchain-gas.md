...
Typically, interchain gas payments should be made by the same smart contract that sent the interchain message.

In some cases (e.g. [quickstarts](../../quickstarts/ "mention")) it may be useful to make gas payments manually.

Read on to make a manual gas payment. To make a manual gas payment, you will need
